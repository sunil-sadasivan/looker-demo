  ...
  derived_table: {
    sql: (SELECT
              ...
              (SELECT MAX(distributed_cases.docket_index)
                       ...
                       WHERE distributed_cases.distribution_id = distributions.id and distributed_cases.priority='false' and distributed_cases.genpop_query='not_genpop' GROUP BY distributions.id) AS "max_nonpriority_not_genpop_docket_index"
