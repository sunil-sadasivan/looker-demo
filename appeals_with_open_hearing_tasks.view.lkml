view: appeals_with_open_hearing_tasks {
  ...
  dimension: open_change_disposition_tasks {
    type: number
    sql: ${TABLE}."open_change_disposition_tasks" ;;
  }

  set: detail {
    fields: [appeal_type, closest_regional_office, total_open_tasks, open_hearing_tasks, open_schedule_hearing_tasks, open_disposition_tasks, open_change_disposition_tasks]
  }
}
